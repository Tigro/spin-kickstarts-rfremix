...
## Fedora Repos
repo --name=fedora --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=fedora-19&arch=$basearch  --exclude kernel*debug* --exclude kernel-kdump* --exclude kernel-tools* --exclude syslog-ng* --exclude astronomy-bookmarks --exclude generic* --exclude btanks* --exclude GConf2-dbus* --exclude bluez-gnome --exclude java-1.8.0-openjdk* --exclude community-mysql* --exclude jruby* --exclude java-*-openjdk-javadoc --exclude abrt --exclude abrt-libs --exclude calligra-l10n --exclude ceph-libcephfs --exclude ceph-libs --exclude eclipse-linuxtools --exclude eclipse-wtp-servertools --exclude file --exclude file-libs --exclude ghostscript --exclude glusterfs --exclude kde-l10n --exclude kde-print-manager --exclude kdenetwork-common --exclude libmongodb --exclude libreoffice-core --exclude libreoffice-opensymbol-fonts --exclude libreoffice-ure --exclude libreoffice-writer --exclude linphone-mediastreamer --exclude ortp
repo --name=fedora-updates --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=updates-released-f19&arch=$basearch  --exclude kernel*debug* --exclude kernel-kdump* --exclude kernel-tools* --exclude syslog-ng* --exclude astronomy-bookmarks --exclude generic* --exclude btanks* --exclude GConf2-dbus* --exclude bluez-gnome --exclude java-1.8.0-openjdk* --exclude community-mysql* --exclude jruby* --exclude java-*-openjdk-javadoc
