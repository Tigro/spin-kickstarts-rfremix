...
repo --name=russianfedora-fixes --mirrorlist=http://mirrors.rfremix.ru/mirrorlist?repo=fixes-fedora-$releasever&arch=$basearch --exclude fontconfig-infinality --exclude cairo-freeworld --exclude freetype-infinality
repo --name=russianfedora-fixes-updates --mirrorlist=http://mirrors.rfremix.ru/mirrorlist?repo=fixes-fedora-updates-released-$releasever&arch=$basearch --exclude fontconfig-infinality --exclude cairo-freeworld --exclude freetype-infinality
